...
if(isset($selector)) {
		...
		echo '<div id="expiredcontent">';
		echo 'Your password reset request has expired. Please request another. ';
		echo '<a href="https://tencharitychallenge.com/passwordreset.php">Click here to try again.</a>';
		echo '</div>';
	}
